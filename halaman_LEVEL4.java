...
public class halaman_LEVEL4 extends World {
    ...
    private void prosesJawaban(String input) {
        ...
        if (input.equalsIgnoreCase(jawabanBenar)) {
            addObject(new peluru_api3(monster), player.getX(), player.getY());
            nyawaMonster--;
    ...
    public void nextLevel() {
        Greenfoot.setWorld(new NEXT_KE_HOME2()); // <-- Jika kamu sudah buat LEVEL3
    }
    /**
    ...
    {
        monster4 monster4 = new monster4();
        addObject(monster4,524,312);
        Player player = new Player();
        addObject(player,346,372);
        KE_AWAL kE_AWAL = new KE_AWAL();
        addObject(kE_AWAL,32,40);
        KE_HOME kE_HOME = new KE_HOME();
        addObject(kE_HOME,869,40);
    }
}
